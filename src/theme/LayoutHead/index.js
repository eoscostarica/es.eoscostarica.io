...
export default function LayoutHead(props) {
  ...
  return <>
      ...
      <Head>
        <link rel="alternate" href={`https://es.eoscostarica.io${location.pathname}`} hreflang="es-us" />
        {hrefLangPath && <link rel="alternate" href={hrefLangPath} hreflang="en-us" />}
        <link rel="canonical" href={`https://es.eoscostarica.io${location.pathname}`} />
      </Head>
