...
const MetaData = {
  ...
  description:
    "En EOS Costa Rica desarrollamos soluciones en blockchain para mejorar la eficiencia, trazabilidad, transparencia y rendición de cuentas en empresas.",
...
const Home = () => {
        ...
        {isDesktop && (
          <Box className="sectionHero">
            <Box className="titleBox">
              <h1>
                Soluciones empresariales <br /> blockchain a su medida
              </h1>
            </Box>
            <p>
              Implemente la tecnología blockchain EOSIO + Antelope para mejorar
              la transparencia y eficiencia, y reducir costos en su
              organización. Comience a transformar su organización con el poder
    ...
    return (
      <Box className="containerSec">
        <Box className={clsx("section", { ["sectionPadding"]: isMobile })}>
          <Box className="titleBox">
            {isDesktop && <h2>Lo que blockchain puede hacer por usted</h2>}
            {isMobile && (
              <>
                <h2>
                  Lo que una blockchain <br /> puede hacer por usted
                </h2>
              </>
            )}
          </Box>
          <Grid container spacing={5}>
            ...
            <Grid item xs={12} md={6}>
              ...
              <p>
                Los contratos inteligentes de la tecnología blockchain permiten
                mayor eficiencia en operaciones. Un contrato inteligente es un
                protocolo que se ejecuta de manera automática y autónoma,
                eliminando la necesidad de un intermediario y reduciendo costos
                de transacción.
              </p>
            </Grid>
            <Grid item xs={12} md={6}>
            ...
            <Grid item xs={12} md={6}>
              ...
              <p>
                Definimos blockchain como una tecnología fundamental que impulsa
                otras tecnologías de la industria 4.0. Por ejemplo, machine
                learning, robótica y realidad virtual pueden integrar blockchain
                para registrar grandes cantidades de información.
              </p>
            </Grid>
          </Grid>
              ...
              <Grid justifyContent="center" container spacing={5}>
                ...
                <Grid item xs={12} md={3}>
                  <Box className="boxFlexEnd">
                    <button
                      className={clsx("buttonSecondary", "specialButton")}
              ...
              <Grid justifyContent="center" container>
                <Grid item xs={11}>
                  <h4 style={{ textAlign: "center" }}>
                    <b>
                      Lea más sobre cómo blockchain puede mejorar sus
                      operaciones.
                    </b>
                  </h4>
                </Grid>
        ...
        <Box className="sectionPadding">
          <Grid container spacing={5}>
            <Grid item xs={12} md={6}>
              ...
              <p>
                Sacamos el mejor provecho a la tecnología blockchain empresarial
                y diseñamos soluciones para el mundo real. Nuestro equipo ofrece
                servicios a la medida según las necesidades y expectativas de
                nuestros clientes.{" ¡"}
                <a href={useBaseUrl("/contactenos")}>Contáctenos</a> y empecemos
                la conversación!
              </p>
              <Box className="accordionBox" style={{ marginTop: "20px" }}>
                ...
                >
                  <AccordionSummary
                    style={{ padding: 1 }}
                    expandIcon={<ExpandMoreIcon style={{ color: "#5484B3" }} />}
                  >
                  ...
                  <AccordionDetails style={{ padding: 1, marginTop: "-15px" }}>
                    <p style={{ padding: 0 }}>
                      Nuestra propuesta de valor es desarrollar software basado
                      en blockchain para resolver problemas de la vida real.
                      Tenemos experiencia trabajando con empresas de gran tamaño
                      y PYMES, entidades de gobierno, organizaciones sin fines
                      de lucro y proyectos de código abierto. Nos adaptamos al
                      presupuesto y necesidades del cliente, sin comprometer el
                      liderazgo o calidad en nuestro trabajo. Nuestro equipo es
                      agnóstico a la tecnología pero nos especializamos en{" "}
                ...
                >
                  ...
                  <AccordionDetails style={{ padding: 0, marginTop: "-15px" }}>
                    <p style={{ padding: 0 }}>
                      ...
                      José, Costa Rica. Costa Rica es un país con alta
                      estabilidad política y una democracia de muchos años.
                      Nuestra ubicación estratégica en la mitad del continente
                      americano ofrece interconectividad conveniente entre
                      redes. Además, configuramos, hospedamos y damos
                      mantenimiento a nodos de blockchain disponibles para redes
                      públicas y privadas con monitoreo y uptime 24/7.{" "}
                      <a href={useBaseUrl("/la-empresa")} target="_blank">
                        {" "}
                        Lea más sobre esto
                      </a>
                      .
                ...
                <Accordion
                  square
                  expanded={expanded === "panel_Education"}
                  onChange={handleChange("panel_Education")}
                  className="accordion"
                  style={{
                    backgroundColor: "#F8F8F8",
                    boxShadow: "none",
                    borderColor: "s\\#f1f1f1",
                  }}
                >
                  <AccordionSummary
                    style={{ padding: 0 }}
                  ...
                  <AccordionDetails style={{ padding: 0, marginTop: "-15px" }}>
                    <p style={{ padding: 0 }}>
                      ...
                      ejecutivos y equipos que buscan actualizarse y aprender
                      más sobre blockchain y casos de uso empresariales. También
  ...
  const EnterpriseBlockchain = () => {
    return (
      <Box className="containerSec">
        <Box className="sectionPadding">
          <Box className="titleBox">
            {isDesktop && <h2>Industrias que pueden implementar blockchain</h2>}
            {isMobile && (
              <>
            ...
            <Grid container spacing={5}>
              <Grid item md={4}>
                ...
                <p>
                  ...
                  <a
                    href={
                      "https://eoscostarica.medium.com/why-integrating-erp-systems-into-blockchain-is-agreat-idea-e384b298a4a8"
                    }
                    target="_blank"
                  >
                    {" "}
              ...
              <Grid item md={4}>
                ...
                <p>
                  ...
                  capacidades de blockchain y de los contratos inteligentes son
                  ideales para trazabilidad, gestión de autorizaciones y
                  automatización.{" "}
                  <a
          ...
          <p>
            <a href={useBaseUrl("/industries")}>
              Descubra más industrias que pueden mejorar
            </a>
          ...
          <Grid container spacing={5}>
            ...
            <Grid item xs={12} md={6}>
              <Box className="inquiereBox">
                <Box style={{ width: "100%" }}>
                  <h2 className={clsx("white", "centerTextOnMobile")}>
                    ¿Tiene preguntas <br /> sobre blockchain?{" "}
                  </h2>
                  <Box className="buttonBox">
                    <button
                      className="buttonPrimary"
              ...
              <Grid container spacing={5}>
                <Grid item md={6}>
                  ...
                  <p>
                    ...
                    solucionar problemas y experiencia en sus áreas de
                    conocimiento. Operamos como un equipo distribuido en un
                    ambiente Agile (ágil) y nos esforzamos por contratar talento
                    fuera de áreas urbanas para apoyar carreras técnicas en
                    zonas rurales.
                    <a
            ...
            <Box className="spacingBox">
              <Grid container spacing={5}>
                ...
                <Grid item md={6}>
                  ...
                  <p>
                    Durante la década de 1980, desarrollamos el primer BBS del
                    país, un precursor de la internet. Luego de décadas de
                    ofrecer infraestructura de internet y servicios de hospedaje
                    y desarrollo, empezamos a ofrecer infraestructura para redes
                    de blockchain públicas. Estuvimos presentes durante el
                    nacimiento de la EOS Mainnet y comenzamos a implementar el
                    protocolo{" "}
                    ...
                    desde su lanzamiento, acumulando así décadas de experiencia
              ...
              <Grid container spacing={5}>
                <Grid item md={6}>
                  ...
                  <p>
                    ...
                    , que ofrece mayor escalabilidad debido a su alta velocidad
                    en transacciones, flexibilidad para redes públicas o
                    privadas y eficiencia energética en comparación con otras
                    blockchains, convirtiéndola en una opción más eco-eficiente.
                  </p>
                </Grid>
                <Grid item md={6}>
                  <Box className="imgBoxRight">
  ...
  const SomeProjects = () => {
    return (
      <Box className="containerSec">
        <Box
          className={clsx("sectionNoPadding", { ["sectionPadding"]: isMobile })}
        >
          <Box className="titleBox">
          ...
          <Box className="spacingBox">
            <p>
              ...
              <a href={useBaseUrl("/proyectos")} target="_blank">
                {" "}
            ...
            <Grid container>
              ...
              <Grid item xs={12} md={6}>
                <Box className="projectsGridRight">
                  ...
                  <p>
                    ...
                    abierto que ofrece una red de blockchain EOSIO que se
                    integra en la red de LACChain.{" "}
              ...
              <Grid style={{ backgroundColor: "#f8f8f8" }} item xs={12} md={6}>
                <Box className="projectsGridRight">
                  ...
                  <p>
                    EOS Rate es una app de código abierto que permite a
                    titulares de tokens EOS acceder a un sistema de
                    calificaciones y portal de votación para productores de
                    bloques y proxies en la blockchain EOS.{" "}
              ...
              <Grid style={{ backgroundColor: "#ffffff" }} item xs={12} md={6}>
                <Box className="projectsGridRight">
                  ...
                  <p>
                    Antelope Tools es un proyecto de código abierto que permite
                    a usuarios visualizar la distribución de recompensas en la
                    red EOS en la búsqueda de rendición de cuentas y
                    transparencia.{" "}
